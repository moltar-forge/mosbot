...
describe('CreateFileModal', () => {
  ...
  it('does not render when isOpen is false', () => {
    render(<CreateFileModal isOpen={false} onClose={mockOnClose} currentPath="/" />);

    expect(screen.queryByText('Create New File')).not.toBeInTheDocument();
  });

  it('renders modal when open', () => {
    render(<CreateFileModal isOpen={true} onClose={mockOnClose} currentPath="/" />);
  ...
  it('displays current path', () => {
    render(<CreateFileModal isOpen={true} onClose={mockOnClose} currentPath="/documents" />);
  ...
  it('shows error for invalid characters', async () => {
    ...
    expect(mockShowToast).toHaveBeenCalledWith('Path contains invalid characters', 'error');
  });
  ...
  it('shows error for path traversal attempts with ..', async () => {
    ...
    expect(mockShowToast).toHaveBeenCalledWith('Path cannot contain ..', 'error');
  });
