...
export default function Toast({ show, message, type = 'success', onClose }) {
  ...
  return (
    ...
    >
      <div
        className={`pointer-events-auto w-full sm:min-w-[300px] sm:max-w-sm overflow-hidden rounded-lg border ${config.borderColor} ${config.bgColor} shadow-lg backdrop-blur-sm`}
      >
        <div className="p-4">
