  ...
  if (loading && !data.running.length && !data.queued.length && !data.completed.length) {
    return (
      <div className="flex flex-col h-full">
        <Header title="Subagents" subtitle="Monitor running, queued, and completed subagents" />
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-dark-400">
                  Completed subagents are retained for{' '}
                  <span className="text-dark-200 font-medium">
                    {data.retention.completedRetentionDays} days
                  </span>
                  . Activity logs are retained for{' '}
                  <span className="text-dark-200 font-medium">
                    {data.retention.activityLogRetentionDays} days
                  </span>
          ...
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-dark-500 text-sm mt-2">
                Subagents will appear here when tasks are executed
              </p>
            </div>
          </div>
        )}
        ...
        {((activeFilter === 'running' && data.running.length === 0 && data.queued.length > 0) ||
          ...
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              {activeFilter === 'completed' && (
                <CheckCircleIcon className="w-16 h-16 text-dark-600 mx-auto mb-4" />
              )}
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-3 text-xs">
                      ...
                      <div>
                        ...
                        <p className="text-dark-300 mt-1">
                          {agent.timeoutMinutes ? `${agent.timeoutMinutes}m` : 'N/A'}
                        </p>
                      </div>
                      <div>
