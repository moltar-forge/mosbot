...
describe('RenameModal', () => {
  ...
  beforeEach(() => {
    ...
    useWorkspaceStore.mockReturnValue({
      ...
      listings: {}, // Add listings to prevent undefined error
    });
  ...
  it('does not render when isOpen is false', () => {
    ...
    render(<RenameModal isOpen={false} onClose={mockOnClose} file={file} />);
  ...
  it('renders modal when open with file', () => {
    const file = { name: 'test.txt', path: '/test.txt', type: 'file' };
    render(<RenameModal isOpen={true} onClose={mockOnClose} file={file} />);
